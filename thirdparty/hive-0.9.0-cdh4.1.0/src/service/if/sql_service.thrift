...
namespace java org.apache.hive.service.sql.thrift
namespace cpp Apache.Hive.Service.Sql.Thrift

// List of protocol versions. A new token should be
// added to the end of this list every time a change is made.
enum TProtocolVersion {
  HIVE_SQL_SERVICE_PROTOCOL_V1
}
...
struct TOpenSessionReq {
  ...
  1: required TProtocolVersion client_protocol = TProtocolVersion.HIVE_SQL_SERVICE_PROTOCOL_V1
...
struct TOpenSessionResp {
  ...
  2: required TProtocolVersion serverProtocolVersion = TProtocolVersion.HIVE_SQL_SERVICE_PROTOCOL_V1
