...
module TProtocolVersion
  ...
  VALUE_MAP = {0 => "HIVE_SQL_SERVICE_PROTOCOL_V1"}
  VALID_VALUES = Set.new([HIVE_SQL_SERVICE_PROTOCOL_V1]).freeze
end
...
module TStatusCode
  ...
  ERROR = 3
  INVALID_HANDLE = 4
  VALUE_MAP = {0 => "SUCCESS", 1 => "SUCCESS_WITH_INFO", 2 => "SQL_STILL_EXECUTING", 3 => "ERROR", 4 => "INVALID_HANDLE"}
  VALID_VALUES = Set.new([SUCCESS, SUCCESS_WITH_INFO, SQL_STILL_EXECUTING, ERROR, INVALID_HANDLE]).freeze
end
...
module TOperationState
  ...
  ERROR = 5
  UKNOWN = 6
  VALUE_MAP = {0 => "INITIALIZED", 1 => "RUNNING", 2 => "FINISHED", 3 => "CANCELED", 4 => "CLOSED", 5 => "ERROR", 6 => "UKNOWN"}
  VALID_VALUES = Set.new([INITIALIZED, RUNNING, FINISHED, CANCELED, CLOSED, ERROR, UKNOWN]).freeze
end
...
module TGetInfoType
  ...
  VALUE_MAP = {0 => "SQL_MAX_DRIVER_CONNECTIONS", 1 => "SQL_MAX_CONCURRENT_ACTIVITIES", 2 => "SQL_DATA_SOURCE_NAME", 8 => "SQL_FETCH_DIRECTION", 13 => "SQL_SERVER_NAME", 14 => "SQL_SEARCH_PATTERN_ESCAPE", 17 => "SQL_DBMS_NAME", 18 => "SQL_DBMS_VER", 19 => "SQL_ACCESSIBLE_TABLES", 20 => "SQL_ACCESSIBLE_PROCEDURES", 23 => "SQL_CURSOR_COMMIT_BEHAVIOR", 25 => "SQL_DATA_SOURCE_READ_ONLY", 26 => "SQL_DEFAULT_TXN_ISOLATION", 28 => "SQL_IDENTIFIER_CASE", 29 => "SQL_IDENTIFIER_QUOTE_CHAR", 30 => "SQL_MAX_COLUMN_NAME_LEN", 31 => "SQL_MAX_CURSOR_NAME_LEN", 32 => "SQL_MAX_SCHEMA_NAME_LEN", 34 => "SQL_MAX_CATALOG_NAME_LEN", 35 => "SQL_MAX_TABLE_NAME_LEN", 43 => "SQL_SCROLL_CONCURRENCY", 46 => "SQL_TXN_CAPABLE", 47 => "SQL_USER_NAME", 72 => "SQL_TXN_ISOLATION_OPTION", 73 => "SQL_INTEGRITY", 81 => "SQL_GETDATA_EXTENSIONS", 85 => "SQL_NULL_COLLATION", 86 => "SQL_ALTER_TABLE", 90 => "SQL_ORDER_BY_COLUMNS_IN_SELECT", 94 => "SQL_SPECIAL_CHARACTERS", 97 => "SQL_MAX_COLUMNS_IN_GROUP_BY", 98 => "SQL_MAX_COLUMNS_IN_INDEX", 99 => "SQL_MAX_COLUMNS_IN_ORDER_BY", 100 => "SQL_MAX_COLUMNS_IN_SELECT", 101 => "SQL_MAX_COLUMNS_IN_TABLE", 102 => "SQL_MAX_INDEX_SIZE", 104 => "SQL_MAX_ROW_SIZE", 105 => "SQL_MAX_STATEMENT_LEN", 106 => "SQL_MAX_TABLES_IN_SELECT", 107 => "SQL_MAX_USER_NAME_LEN", 115 => "SQL_OJ_CAPABILITIES", 10000 => "SQL_XOPEN_CLI_YEAR", 10001 => "SQL_CURSOR_SENSITIVITY", 10002 => "SQL_DESCRIBE_PARAMETER", 10003 => "SQL_CATALOG_NAME", 10004 => "SQL_COLLATION_SEQ", 10005 => "SQL_MAX_IDENTIFIER_LEN"}
  VALID_VALUES = Set.new([SQL_MAX_DRIVER_CONNECTIONS, SQL_MAX_CONCURRENT_ACTIVITIES, SQL_DATA_SOURCE_NAME, SQL_FETCH_DIRECTION, SQL_SERVER_NAME, SQL_SEARCH_PATTERN_ESCAPE, SQL_DBMS_NAME, SQL_DBMS_VER, SQL_ACCESSIBLE_TABLES, SQL_ACCESSIBLE_PROCEDURES, SQL_CURSOR_COMMIT_BEHAVIOR, SQL_DATA_SOURCE_READ_ONLY, SQL_DEFAULT_TXN_ISOLATION, SQL_IDENTIFIER_CASE, SQL_IDENTIFIER_QUOTE_CHAR, SQL_MAX_COLUMN_NAME_LEN, SQL_MAX_CURSOR_NAME_LEN, SQL_MAX_SCHEMA_NAME_LEN, SQL_MAX_CATALOG_NAME_LEN, SQL_MAX_TABLE_NAME_LEN, SQL_SCROLL_CONCURRENCY, SQL_TXN_CAPABLE, SQL_USER_NAME, SQL_TXN_ISOLATION_OPTION, SQL_INTEGRITY, SQL_GETDATA_EXTENSIONS, SQL_NULL_COLLATION, SQL_ALTER_TABLE, SQL_ORDER_BY_COLUMNS_IN_SELECT, SQL_SPECIAL_CHARACTERS, SQL_MAX_COLUMNS_IN_GROUP_BY, SQL_MAX_COLUMNS_IN_INDEX, SQL_MAX_COLUMNS_IN_ORDER_BY, SQL_MAX_COLUMNS_IN_SELECT, SQL_MAX_COLUMNS_IN_TABLE, SQL_MAX_INDEX_SIZE, SQL_MAX_ROW_SIZE, SQL_MAX_STATEMENT_LEN, SQL_MAX_TABLES_IN_SELECT, SQL_MAX_USER_NAME_LEN, SQL_OJ_CAPABILITIES, SQL_XOPEN_CLI_YEAR, SQL_CURSOR_SENSITIVITY, SQL_DESCRIBE_PARAMETER, SQL_CATALOG_NAME, SQL_COLLATION_SEQ, SQL_MAX_IDENTIFIER_LEN]).freeze
end
...
class TGetFunctionsReq
  ...
  FIELDS = {
    ...
    CATALOGNAME => {:type => ::Thrift::Types::STRING, :name => 'catalogName', :optional => true},
    SCHEMANAME => {:type => ::Thrift::Types::STRING, :name => 'schemaName', :optional => true},
    FUNCTIONNAME => {:type => ::Thrift::Types::STRING, :name => 'functionName', :optional => true}
  }
