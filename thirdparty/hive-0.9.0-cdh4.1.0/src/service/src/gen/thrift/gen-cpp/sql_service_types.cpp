...
int _kTProtocolVersionValues[] = {
  TProtocolVersion::HIVE_SQL_SERVICE_PROTOCOL_V1
};
...
int _kTStatusCodeValues[] = {
  TStatusCode::SUCCESS,
  TStatusCode::SUCCESS_WITH_INFO,
  TStatusCode::SQL_STILL_EXECUTING,
  TStatusCode::ERROR,
  TStatusCode::INVALID_HANDLE
};
...
int _kTOperationStateValues[] = {
  TOperationState::INITIALIZED,
  TOperationState::RUNNING,
  TOperationState::FINISHED,
  TOperationState::CANCELED,
  TOperationState::CLOSED,
  TOperationState::ERROR,
  TOperationState::UKNOWN
};
...
int _kTGetInfoTypeValues[] = {
  TGetInfoType::SQL_MAX_DRIVER_CONNECTIONS,
  TGetInfoType::SQL_MAX_CONCURRENT_ACTIVITIES,
  TGetInfoType::SQL_DATA_SOURCE_NAME,
  TGetInfoType::SQL_FETCH_DIRECTION,
  TGetInfoType::SQL_SERVER_NAME,
  TGetInfoType::SQL_SEARCH_PATTERN_ESCAPE,
  TGetInfoType::SQL_DBMS_NAME,
  TGetInfoType::SQL_DBMS_VER,
  TGetInfoType::SQL_ACCESSIBLE_TABLES,
  TGetInfoType::SQL_ACCESSIBLE_PROCEDURES,
  TGetInfoType::SQL_CURSOR_COMMIT_BEHAVIOR,
  TGetInfoType::SQL_DATA_SOURCE_READ_ONLY,
  TGetInfoType::SQL_DEFAULT_TXN_ISOLATION,
  TGetInfoType::SQL_IDENTIFIER_CASE,
  TGetInfoType::SQL_IDENTIFIER_QUOTE_CHAR,
  TGetInfoType::SQL_MAX_COLUMN_NAME_LEN,
  TGetInfoType::SQL_MAX_CURSOR_NAME_LEN,
  TGetInfoType::SQL_MAX_SCHEMA_NAME_LEN,
  TGetInfoType::SQL_MAX_CATALOG_NAME_LEN,
  TGetInfoType::SQL_MAX_TABLE_NAME_LEN,
  TGetInfoType::SQL_SCROLL_CONCURRENCY,
  TGetInfoType::SQL_TXN_CAPABLE,
  TGetInfoType::SQL_USER_NAME,
  TGetInfoType::SQL_TXN_ISOLATION_OPTION,
  TGetInfoType::SQL_INTEGRITY,
  TGetInfoType::SQL_GETDATA_EXTENSIONS,
  TGetInfoType::SQL_NULL_COLLATION,
  TGetInfoType::SQL_ALTER_TABLE,
  TGetInfoType::SQL_ORDER_BY_COLUMNS_IN_SELECT,
  TGetInfoType::SQL_SPECIAL_CHARACTERS,
  TGetInfoType::SQL_MAX_COLUMNS_IN_GROUP_BY,
  TGetInfoType::SQL_MAX_COLUMNS_IN_INDEX,
  TGetInfoType::SQL_MAX_COLUMNS_IN_ORDER_BY,
  TGetInfoType::SQL_MAX_COLUMNS_IN_SELECT,
  TGetInfoType::SQL_MAX_COLUMNS_IN_TABLE,
  TGetInfoType::SQL_MAX_INDEX_SIZE,
  TGetInfoType::SQL_MAX_ROW_SIZE,
  TGetInfoType::SQL_MAX_STATEMENT_LEN,
  TGetInfoType::SQL_MAX_TABLES_IN_SELECT,
  TGetInfoType::SQL_MAX_USER_NAME_LEN,
  TGetInfoType::SQL_OJ_CAPABILITIES,
  TGetInfoType::SQL_XOPEN_CLI_YEAR,
  TGetInfoType::SQL_CURSOR_SENSITIVITY,
  TGetInfoType::SQL_DESCRIBE_PARAMETER,
  TGetInfoType::SQL_CATALOG_NAME,
  TGetInfoType::SQL_COLLATION_SEQ,
  TGetInfoType::SQL_MAX_IDENTIFIER_LEN
};
...
const char* TGetFunctionsReq::ascii_fingerprint = "9D80D8F65FC9AFDFA18C7FD8CC4B78BE";
const uint8_t TGetFunctionsReq::binary_fingerprint[16] = {0x9D,0x80,0xD8,0xF6,0x5F,0xC9,0xAF,0xDF,0xA1,0x8C,0x7F,0xD8,0xCC,0x4B,0x78,0xBE};
