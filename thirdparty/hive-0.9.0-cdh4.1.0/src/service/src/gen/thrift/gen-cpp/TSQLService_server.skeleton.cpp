...
using namespace Apache::Hive::Service::Sql::Thrift;

class TSQLServiceHandler : virtual public TSQLServiceIf {
 public:
  TSQLServiceHandler() {
...
int main(int argc, char **argv) {
  int port = 9090;
  shared_ptr<TSQLServiceHandler> handler(new TSQLServiceHandler());
  shared_ptr<TProcessor> processor(new TSQLServiceProcessor(handler));
