 ...
 */
#ifndef sql_service_TYPES_H
#define sql_service_TYPES_H
...
typedef struct _TGetFunctionsReq__isset {
  _TGetFunctionsReq__isset() : catalogName(false), schemaName(false), functionName(false) {}
  bool catalogName;
  bool schemaName;
  bool functionName;
...
class TGetFunctionsReq {
 public:
  ...
  static const char* ascii_fingerprint; // = "9D80D8F65FC9AFDFA18C7FD8CC4B78BE";
  static const uint8_t binary_fingerprint[16]; // = {0x9D,0x80,0xD8,0xF6,0x5F,0xC9,0xAF,0xDF,0xA1,0x8C,0x7F,0xD8,0xCC,0x4B,0x78,0xBE};
