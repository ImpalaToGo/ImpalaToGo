...
import org.apache.hive.service.sql.thrift.TOperationState;
...
public enum OperationState {
  INITIALIZED(TOperationState.INITIALIZED),
  RUNNING(TOperationState.RUNNING),
  FINISHED(TOperationState.FINISHED),
  CANCELED(TOperationState.CANCELED),
  CLOSED(TOperationState.CLOSED),
  ERROR(TOperationState.ERROR),
  UNKNOWN(TOperationState.UKNOWN);
