Apache Hive (TM) 0.10.0-cdh4.5.0
======================
...
- Hive 0.10.0-cdh4.5.0 includes changes to the MetaStore schema. If
...
- Hive 0.10.0-cdh4.5.0 includes new configuration properties. If you
