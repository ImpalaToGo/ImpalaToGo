...
export IMPALA_HADOOP_VERSION=2.3.0-cdh5.1.1-SNAPSHOT
export IMPALA_HBASE_VERSION=0.98.1-cdh5.1.1-SNAPSHOT
export IMPALA_HIVE_VERSION=0.12.0-cdh5.1.1-SNAPSHOT
export IMPALA_SENTRY_VERSION=1.3.0-cdh5.1.1-SNAPSHOT
export IMPALA_LLAMA_VERSION=1.0.0-cdh5.1.1-SNAPSHOT
export IMPALA_AVRO_VERSION=1.7.4
export IMPALA_PARQUET_VERSION=1.2.5-cdh5.1.1-SNAPSHOT
