...
export IMPALA_HADOOP_VERSION=2.5.0-cdh5.2.3
export IMPALA_HBASE_VERSION=0.98.6-cdh5.2.3
export IMPALA_HIVE_VERSION=0.13.1-cdh5.2.3
export IMPALA_SENTRY_VERSION=1.4.0-cdh5.2.3
export IMPALA_LLAMA_VERSION=1.0.0-cdh5.2.3
export IMPALA_AVRO_VERSION=1.7.4
export IMPALA_PARQUET_VERSION=1.5.0-cdh5.2.3
