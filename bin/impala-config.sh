...
export IMPALA_HADOOP_VERSION=2.3.0-cdh5.0.1
export IMPALA_HBASE_VERSION=0.96.1.1-cdh5.0.1
export IMPALA_HIVE_VERSION=0.12.0-cdh5.0.1
export IMPALA_SENTRY_VERSION=1.2.0-cdh5.0.1
export IMPALA_LLAMA_VERSION=1.0.0-cdh5.0.1
