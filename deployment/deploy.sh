...
scp -rp -i $KEY /root/ImpalaToGo/thirdparty/tachyon-0.7.0-SNAPSHOT/conf/* ec2-user@$TARGET_HOST:/home/ec2-user/build/tachyon/conf/
scp -rp -i $KEY /root/ImpalaToGo/thirdparty/tachyon-0.7.0-SNAPSHOT/bin/* ec2-user@$TARGET_HOST:/home/ec2-user/build/tachyon/bin/
scp -rp -i $KEY /root/ImpalaToGo/thirdparty/tachyon-0.7.0-SNAPSHOT/libexec/* ec2-user@$TARGET_HOST:/home/ec2-user/build/tachyon/libexec/
