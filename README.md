...
ImpalaToGo is a fork of Cloudera Impala, separated from Hadoop. It is optimized to work with S3 storage by caching data locally. It introduces support for hierarchical data querying, currently starting with JSON format.
...
5. It gives an ability to query JSON-formatted data, which is the start for more wide veriety of hierarchical data formats support. See [JSON data support how to](wiki/JSON-data-support----how-to)
