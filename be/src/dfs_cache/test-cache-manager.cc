...
SessionContext CacheMgrTest::m_ctx3 = nullptr;
SessionContext CacheMgrTest::m_ctx4 = nullptr;
SessionContext CacheMgrTest::m_ctx5 = nullptr;
SessionContext CacheMgrTest::m_ctx6 = nullptr;

TEST_F(CacheMgrTest, EstmateDatasetTaskAsync){
...
TEST_F(CacheMgrTest, EstmateDatasetTaskSync){
...
TEST_F(CacheMgrTest, EstmateDatasetFewTasksAsync){
	...
	auto fumanual1 = spawn_task(f1, m_ctx1, std::cref(m_namenode1),
			std::cref(data), std::ref(time), cb, std::ref(identity), true);
	auto fumanual2 = spawn_task(f1, m_ctx2, std::cref(m_namenode1),
			std::cref(data), std::ref(time), cb, std::ref(identity), true);
	auto fumanual3 = spawn_task(f1, m_ctx3, std::cref(m_namenode1),
			std::cref(data), std::ref(time), cb, std::ref(identity), true);
	auto fumanual4 = spawn_task(f1, m_ctx4, std::cref(m_namenode1),
			std::cref(data), std::ref(time), cb, std::ref(identity), true);
	auto fumanual5 = spawn_task(f1, m_ctx5, std::cref(m_namenode1),
			std::cref(data), std::ref(time), cb, std::ref(identity), true);
	auto fumanual6 = spawn_task(f1, m_ctx6, std::cref(m_namenode1),
			std::cref(data), std::ref(time), cb, std::ref(identity), true);
	...
	auto future1 =
			std::async(std::launch::async,
					[&] {return f1(m_ctx1, std::cref(m_namenode1), std::cref(data), std::ref(time), cb, std::ref(identity), true);});
	auto future2 =
			std::async(std::launch::async,
					[&] {return f1(m_ctx2, std::cref(m_namenode1), std::cref(data), std::ref(time), cb, std::ref(identity), true);});
	auto future3 =
			std::async(std::launch::async,
					[&] {return f1(m_ctx3, std::cref(m_namenode1), std::cref(data), std::ref(time), cb, std::ref(identity), true);});
	auto future4 =
			std::async(std::launch::async,
					[&] {return f1(m_ctx4, std::cref(m_namenode1), std::cref(data), std::ref(time), cb, std::ref(identity), true);});
	auto future5 =
			std::async(std::launch::async,
					[&] {return f1(m_ctx5, std::cref(m_namenode1), std::cref(data), std::ref(time), cb, std::ref(identity), true);});
	auto future6 =
			std::async(std::launch::async,
					[&] {return f1(m_ctx6, std::cref(m_namenode1), std::cref(data), std::ref(time), cb, std::ref(identity), true);});
